...
RSpec.describe ConfigCat::ConfigCatClient do
  it "test_ensure_singleton_per_sdk_key" do
    client1 = ConfigCatClient.get('test', options: ConfigCatOptions.new(polling_mode: PollingMode.manual_poll))
    client2 = ConfigCatClient.get('test', options: ConfigCatOptions.new(polling_mode: PollingMode.manual_poll))
  ...
  it "test_get_all_value_details" do
    client = ConfigCatClient.get('test', options: ConfigCatOptions.new(polling_mode: PollingMode.manual_poll, config_cache: ConfigCacheMock.new))
