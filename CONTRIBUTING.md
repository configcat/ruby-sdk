# Contributing to the ConfigCat SDK for Ruby
...
The ConfigCat SDK team monitors the [issue tracker](https://github.com/configcat/ruby-sdk/issues) in the SDK repository. Bug reports and feature requests specific to this SDK should be filed in this issue tracker. The team will respond to all newly filed issues.
...
This ConfigCat SDK is built with [Bundler](https://bundler.io). To install Bundler, run `gem install bundler`.
